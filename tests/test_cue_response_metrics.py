...
def test_unified_analysis_includes_visual_action_plan_id(tmp_path) -> None:
    session = tmp_path / "visual_action_session"
    session.mkdir()
    _write_json(
        session / "summary.json",
        {
            "session_id": "visual_action_session",
            "participant_id": "p01",
            "visual_cue_plan_id": "visual-action-1",
